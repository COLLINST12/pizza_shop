...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post pizzas_url, params: { pizza: { cost: @pizza.cost, crust: @pizza.crust, crust: @pizza.crust, image: @pizza.image, name: @pizza.name, name: @pizza.name, sauce: @pizza.sauce, toppings: @pizza.toppings } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { cost: @pizza.cost, crust: @pizza.crust, crust: @pizza.crust, image: @pizza.image, name: @pizza.name, name: @pizza.name, sauce: @pizza.sauce, toppings: @pizza.toppings } }
